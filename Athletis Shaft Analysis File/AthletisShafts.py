...
if part in val1:
    ...
    plt.suptitle(part)
    plt.legend(loc = "upper right")
    plt.axhline(y=1.749, color = "g", linewidth=2, linestyle = "dashed")
    ...
    plt.suptitle(part)
    plt.legend(loc = "upper right")
    plt.axhline(y=0.1016, color = "g", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel("Time", color = "green")
    plt.ylabel("Measurement [mm]", color = "green")
    ...
    plt.title("Out of Round")
    plt.suptitle(part)
    plt.axhline(y=0.1016, color = "orange", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel(lot)
    plt.ylabel("Measurement [mm]", color = "green")
    ...
    plt.legend(loc = "upper right")
    plt.axhline(y=0.1016, color = "g", linewidth=2, linestyle = "dashed", label = "test")
    plt.axhline(y=0.132, color = "g", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel("Time", color = "green")
    plt.ylabel("Measurement [mm]", color = "green")
    ...
    plt.suptitle(part)
    plt.axhline(y=0.1016, color = "orange", linewidth=2, linestyle = "dashed", label = "test")
    plt.axhline(y=0.132, color = "orange", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel(lot)
    plt.ylabel("Measurement [mm]", color = "green")
    ...
    plt.suptitle(part)
    plt.legend(loc = "upper right")
    plt.axhline(y=0.1524, color = "g", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel("Time", color = "green")
    plt.ylabel("Measurement [mm]", color = "green")
    ...
    plt.title("Guidewire Lumen Wall")
    plt.suptitle(part)
    plt.axhline(y=0.1524, color = "orange", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel(lot)
    plt.ylabel("Measurement [mm]", color = "green")
    ...
    plt.suptitle(part)
    plt.legend(loc = "upper right")
    plt.axhline(y=0.4445, color = "g", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel("Time", color = "green")
    plt.ylabel("Measurement [mm]", color = "green")
    ...
    plt.title("Outside Diameter")
    plt.suptitle(part)
    plt.axhline(y=0.4445, color = "orange", linewidth=2, linestyle = "dashed", label = "test")
    plt.tick_params(axis='x', colors='grey', direction='out', length=4, width=2)
    plt.tick_params(axis='y', colors='grey', direction='out', length=4, width=2)
    plt.xlabel(lot)
    plt.ylabel("Measurement [mm]", color = "green")
